  ...
  return (
    <>
      <section className=" bg-primary-50 dark:bg-muted bg-dotted-pattern bg-cover bg-center py-5 md:py-10">
        <h3 className="wrapper h3-bold text-center sm:text-left ">{t('title')}</h3>
      </section>
        ...
        <table className="w-full border-collapse border-t">
          <thead>
            <tr className="p-medium-14 border-b text-grey-500 dark:text-muted-foreground">
              ...
              <th className="min-w-[200px] flex-1 py-3 pr-4 text-left">{t('sampleName')}</th>
              <th className="min-w-[150px] py-3 text-left">{t('buyer')}</th>
              <th className="min-w-[100px] py-3 text-left">{t('created')}</th>
