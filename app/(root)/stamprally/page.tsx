...
export default function StampRallyPage() {
  ...
  return (
    <section className="wrapper my-8 flex flex-col gap-8">
      <h2 className="h2-bold">🎫 Stamp Rally</h2>
      <p className="text-muted-foreground">
        Tổng cộng <span className="font-semibold text-primary-500">{rallies.length}</span> stamp rally. Mua hàng tại các gian tham gia để thu nhập con dấu và đổi quà!
      </p>
      ...
      <div className="grid gap-6 sm:grid-cols-1 lg:grid-cols-2">
        {rallies.map((rally, index) => (
          ...
          >
            ...
            <div>
              <p className="text-sm font-semibold mb-1">Gian hàng tham gia ({rally.booths.length}):</p>
