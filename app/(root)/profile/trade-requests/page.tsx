    ...
    <>
      <section className="bg-primary-50 dark:bg-muted bg-dotted-pattern bg-cover bg-center py-5 md:py-10">
        <div className="wrapper flex items-center justify-between">
          <h3 className="h3-bold">Quản lý yêu cầu đổi card</h3>
      ...
      <section className="wrapper my-8 flex flex-col gap-8">
        ...
        <div>
          <h4 className="text-lg font-bold mb-4">Yêu cầu nhận được ({incomingRequests.length})</h4>
          {incomingRequests.length === 0 ? (
            <p className="text-sm text-muted-foreground">Chưa có yêu cầu đổi card nào.</p>
          ) : (
        ...
        <div>
          <h4 className="text-lg font-bold mb-4">Yêu cầu đã gửi ({outgoingRequests.length})</h4>
          {outgoingRequests.length === 0 ? (
            <p className="text-sm text-muted-foreground">Bạn chưa gửi yêu cầu đổi card nào.</p>
          ) : (
            <div className="flex flex-col gap-3">
                    ...
                    <div className="flex-1 min-w-0">
                      <div className="flex items-center justify-between gap-2">
                        <div className="min-w-0">
                          <p className="text-sm font-semibold truncate">{ocName}</p>
                          <p className="text-xs text-muted-foreground">
                            Chủ card: {req.card?.ownerName || "Unknown"}
                          </p>
                        </div>
                        {statusBadge}
                      </div>
